    ...
    if (businessError || rafflesError) {
        return (
            <FeedbackScreen
                ...
                description={businessError?.message || rafflesError?.message || "Ocurrió un error inesperado."}
            />
        );
    }
    ...
    return (
        ...
        >
            ...
            <Modal isOpen={showInfoModal} onClose={() => setShowInfoModal(false)} size="md">
                ...
                <ModalContent>
                    <ModalHeader>
                        <Heading size="lg" className="text-primary-500">Información</Heading>
                    </ModalHeader>
                    <ModalBody>
                        <Text className="mb-4 text-typography-600">
                            Las Rifas Anuales son una estrategia opcional para incentivar la acumulación de puntos durante un periodo largo (365 días).
                        </Text>
                        <Text className="mb-4 text-typography-600">
                            <Text bold className="text-primary-500">Mecánica: </Text>
                            Los clientes compran boletos con sus puntos, lo que impulsa el canje y la retención.
                        </Text>
                        <Text className="text-typography-600">
                            <Text bold className="text-primary-500">Cláusula Importante: </Text>
                            Todos los puntos utilizados para comprar boletos serán consumidos inmediatamente y no son reembolsables.
                        </Text>
                    </ModalBody>
                    <ModalFooter>
                        <Button
