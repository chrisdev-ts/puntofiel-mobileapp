...
import { ActivityIndicator, Pressable, Image as RNImage, View } from 'react-native';
        ...
        {promotion.imageUrl && !imageError ? (
          ...
          <View className="w-full h-48 bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center">
            <VStack className="gap-2 items-center">
              ...
              <Text className="text-blue-600 text-sm font-medium">Sin imagen</Text>
            </VStack>
          </View>
        )}
        ...
        <VStack className="p-4 gap-3">
          ...
          <HStack className="justify-between items-start gap-2">
            <VStack className="flex-1 gap-1">
              ...
              <Badge className={`${getStatusColor()} px-2 py-1 rounded self-start`}>
                <BadgeText className={`text-xs font-semibold ${getStatusTextColor()}`}>
                  {getStatusLabel()}
                </BadgeText>
              </Badge>
            </VStack>
