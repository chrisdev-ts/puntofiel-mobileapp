...
export const createRewardSchema = z.object({
    ...
    description: z
        ...
        .refine(
            ...
            {
                message: 'La descripción debe tener al menos 10 caracteres (sin contar espacios)',
            }
        )
        .refine(
            (val) => {
            ...
            {
                message: 'La descripción no puede exceder 200 caracteres (sin contar espacios)',
            }
        ),
