	...
	return (
		<VStack space="lg">
			...
			<FormControl isInvalid={!!errors.prize} isRequired>
				...
				<Controller
					...
					render={({ field: { onChange, onBlur, value } }) => (
						...
						>
							<InputField
								placeholder="Ej. Motocicleta 2025"
								value={value}
								onChangeText={onChange}
								onBlur={onBlur}
							/>
				...
				/>
				<FormControlError>
					<FormControlErrorText>{errors.prize?.message}</FormControlErrorText>
				</FormControlError>
			</FormControl>
				...
				<Controller
					...
					render={({ field: { onChange, onBlur, value } }) => (
						<Textarea className="bg-white border border-gray-300 rounded-lg min-h-[100px]">
							<TextareaInput
								placeholder="Describe las bases..."
								value={value}
								onChangeText={onChange}
								onBlur={onBlur}
							/>
			...
			<FormControl isInvalid={!!errors.max_tickets_per_user} isRequired>
				...
				<FormControlError>
					<FormControlErrorText>
						{errors.max_tickets_per_user?.message}
					</FormControlErrorText>
				</FormControlError>
			</FormControl>
					...
					render={({ field: { value, onChange } }) => (
						<>
							<Pressable
								onPress={() => {
									Keyboard.dismiss();
									setShowPicker({ show: true, mode: "start" });
								}}
							>
					...
					render={({ field: { value, onChange } }) => (
						<>
							<Pressable
								onPress={() => {
									Keyboard.dismiss();
									setShowPicker({ show: true, mode: "end" });
								}}
							>
			...
			<Button
				onPress={onNext}
				size="lg"
				className="bg-[#2F4858] active:bg-[#1A2830] rounded-lg mt-4 mb-6"
			>
