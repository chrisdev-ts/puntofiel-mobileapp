...
export function BusinessHoursSelector({ onChange, initialValue }: BusinessHoursSelectorProps) {
    ...
    const formatHours = (hoursState: BusinessHoursState): string => {
        const ranges: string[] = [];
        let currentRange: { days: DayOfWeek[]; from: string; to: string } | null = null;
    ...
    const formatRange = (range: { days: DayOfWeek[]; from: string; to: string }): string => {
    ...
    const handleTimeChange = (day: DayOfWeek, type: "from" | "to", date: Date) => {
        const newHours = {
            ...hours,
            [day]: {
                ...hours[day],
                        ...
                        <VStack className="gap-3">
                            ...
                            {!isOpen && (
                                <HStack className="items-center gap-2">
                                    <Icon as={Trash2Icon} size="sm" className="text-gray-500" />
